...
const ExportOptionsModal: React.FC<ExportOptionsModalProps> = ({
  ...
  return (
    <div className="fixed inset-0 bg-black/50 backdrop-blur-sm z-[102] flex items-center justify-center p-4" onClick={handleClose} onKeyDown={(e) => e.key === 'Escape' && !isExporting && handleClose()}>
              ...
              <div className="text-center">
                <div className="w-16 h-16 mx-auto mb-4 relative">
                  ...
                  <div className="absolute inset-0 flex items-center justify-center">
                    <span className="text-lg font-bold text-brand-blue">{exportProgress}%</span>
                  </div>
                </div>
